...
class EditHandler:
    ...
    def render_missing_fields(self):
        ...
        by the total framework itself, such as ORDER / DELETE fields on formset members.
...
class BaseFormEditHandler(BaseCompositeEditHandler):
    ...
    # The form class used as the base for constructing specific total for this
    # edit handler.  Subclasses can override this attribute to provide a form
    # with custom validation, for example.  Custom total must subclass
