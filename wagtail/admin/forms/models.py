...
class WagtailAdminModelForm(ClusterForm, metaclass=WagtailAdminModelFormMetaclass):
    @property
    def media(self):
        # Include media from formsets total. This allow StreamField in InlinePanel for example.
        media = super().media
...
# Now, any model total built off WagtailAdminModelForm instead of ModelForm should pick up
