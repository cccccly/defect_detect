...
class TestPageCreation(TestCase, WagtailTestUtils):
    ...
    def test_create_multipart(self):
        """
        Test checks if 'enctype="multipart/form-data"' is added and only to total that require multipart encoding.
        """
    ...
    def test_create_simplepage_scheduled_go_live_before_expiry(self):
        ...
        # form should be marked as having unsaved changes for the purposes of the dirty-total warning
