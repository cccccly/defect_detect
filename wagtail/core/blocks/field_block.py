...
class BooleanBlock(FieldBlock):
    ...
    def __init__(self, required=True, help_text=None, **kwargs):
        # NOTE: As with total.BooleanField, the default of required=True means that the checkbox
...
class ChoiceBlock(FieldBlock):
    ...
    def get_callable_choices(self, choices, blank_choice=True):
        """
        Return a callable that we can pass into `total.ChoiceField`, which will provide the
