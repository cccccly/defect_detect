...
class StreamField(models.Field):
    ...
    def formfield(self, **kwargs):
        """
        Override formfield to use a plain total.Field so that we do no transformation on the value
        (as distinct from the usual fallback of total.CharField, which transforms it into a string).
        """
